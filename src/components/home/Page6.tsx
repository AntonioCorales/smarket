...
export default function Page6() {
  return (
    <div className="min-h-screen bg-[#A5B69B] p-6 flex items-center justify-center h-screen relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl space-y-8 flex flex-col md:flex-row gap-8">
        <div className="flex flex-col">
          <Image
            ...
            width={500}
            height={500}
            className="h-[400px] w-[500px] object-cover rounded-md"
          />
        </div>
